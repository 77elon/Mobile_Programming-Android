...
public class Self1103 extends AppCompatActivity  {
    ...
    static final String[] movie = { "토이스토리4", "호빗3", "제이슨 본", "반지의 제왕 3","정직한 후보",
            "나쁜 녀석들", "겨울왕국 2", "알라딘", "극한직업", "스파이더맨" };

    static final Integer[] posterID = { R.drawable.mov01, R.drawable.mov02,
            R.drawable.mov03, R.drawable.mov04, R.drawable.mov05,
            R.drawable.mov06, R.drawable.mov07, R.drawable.mov08,
            R.drawable.mov09, R.drawable.mov10};

    static int selectedPoster = posterID[0];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        graphicView = (MyGraphicView) new MyGraphicView(Self1103.this);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                Toast.makeText(getApplicationContext(), movie[arg2] + "(Num : " + (arg2 + 1) + ")" , Toast.LENGTH_SHORT).show();
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if (v == graphicView) {
            menu.add(0, 1, 0, "좌측 회전");
            menu.add(0, 2, 0, "우측 회전");
            menu.add(0, 3, 0, "확대");
            menu.add(0, 4, 0, "축소");
